...
public class LoginPageElements extends CommonMethods {
	...
	@FindBy(xpath = "//a[contains(text(),'Welcome Freedy')]")
	public WebElement WelcomeFreedy;
	...
	public WebElement PasswordCanNotBeEmptyMSG;
	
	
	@FindBy(xpath = "//span[contains (text(),'Username cannot be empty')]")
	public WebElement usernameCannotBeEmptyMsg;
